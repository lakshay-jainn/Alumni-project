...
import ProfanityFilter from "@/utils/sanitizeAndNormalize"
...
export function Post({
  ...
  return (
    ...
    <Card className="w-full max-w-[1095px] mx-auto">
      ...
      <div className={`flex flex-col lg:max-h-[600px] h-full ${isTextOnly ? "lg:flex-col" : "lg:flex-row"}`}>
        {isTextOnly ? (
          <div className="p-4">
          ...
          <>
            <div className={`lg:w-[55%] content-center ${showAllComments ? "hidden lg:block" : ""}`}>
              <img
            ...
            <div className="lg:w-[45%] flex flex-col lg:border-l">
                      ...
                      {sortedComments.slice(0, 2).map((comment) => (
                        <div key={comment.id} className="flex items-start gap-2">
                          ...
                          <div className="flex-1">
                            ...
                            >
                              <ThumbsUp
                                className={`h-3 w-3 mr-1 ${comment.isLiked ? "fill-blue-500 text-blue-500" : ""}`}
                              />
                              {comment.likes} {comment.likes === 1 ? "like" : "likes"}
                            </Button>
                          </div>
              ...
              <div className="p-4 border-t">
                <div className="flex items-center justify-between w-full mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <Button variant="ghost" size="icon" onClick={toggleComments} className="lg:hidden">
