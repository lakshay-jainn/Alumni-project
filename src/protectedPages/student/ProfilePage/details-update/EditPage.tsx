...
const routeIconMap : RouteIconMap = {
        '/profile/personal-details/': [<User className="scale-150" />,'Personal Details'],
        '/profile/educational-details/': [<GraduationCap className="scale-150" />,'Educational Details'],
        '/profile/experience-details/': [<BriefcaseBusiness className="scale-150" />,'Experience Details'],
        '/profile/skills-details/': [<Cpu className="scale-150" />,'Skill Details'],
        '/profile/employment-details/': [<Newspaper className="scale-150" />,'Employment Details'],
    };
