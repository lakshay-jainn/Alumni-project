        ...
        <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <div className="relative w-full h-[500px] md:h-[600px] overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-6">
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">Welcome to Hansraj College's</h1>
                    <h3 className="text-4xl md:text-5xl font-extrabold p-4 mb-2 text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-white">Alumni-Connect</h3>
                    ...
                    <div className="mt-8">
                        <button className="px-6 py-3 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full text-white font-semibold transition-all duration-300 backdrop-blur-sm border border-white border-opacity-20">
                            Join the Network
                        </button>
                    </div>
                </div>
            ...
            <div className="container mx-auto px-4 md:px-6 py-16">
                <div className="mb-12 flex flex-col items-center text-center border-none rounded-xl py-8 px-6 bg-white shadow-lg hover:shadow-xl transition-all duration-300">
                    <span className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-gray-700 mb-8">Overview</span>
                    <div className="text-base md:text-xl max-w-8xl">
